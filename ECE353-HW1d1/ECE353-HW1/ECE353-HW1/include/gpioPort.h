...
//*****************************************************************************
// Disable pins as their alternate function (AFSEL)
//
// Paramters
//    baseAddr - Base address of GPIO port that is being enabled.
//    pins  -   A bit mask indicating which pins should be disabled as 
//              alternate functions
//*****************************************************************************
bool  gpio_config_disable_alternate_function(uint32_t baseAddr, uint8_t pins);
...
//*****************************************************************************
// Configure pins to disable port control register (PCTL)
//
// Paramters
//    baseAddr - Base address of GPIO port that is being enabled.
//    pins  -   A bit mask indicating which pins should be disabled for the 
//              specified port control register.
//*****************************************************************************
bool  gpio_config_disable_port_control(uint32_t baseAddr, uint32_t pins);


//*****************************************************************************
// Configure pins for 4mA drive strength
//
// Paramters
//    baseAddr - Base address of GPIO port that is being enabled.
//    pins  -   A bit mask indicating which pins should be configured for 4mA
//*****************************************************************************
bool  gpio_config_drive_4mA(uint32_t baseAddr, uint8_t pins);

//*****************************************************************************
// Configure pins falling edge interrupts
//
// Paramters
//    baseAddr - Base address of GPIO port that is being enabled.
//    pins  -   A bit mask indicating which pins should be configured for 4mA
...
//    irq_priority - 
//*****************************************************************************
bool gpio_enable_irq_falling(uint32_t baseAddr, uint8_t pins, IRQn_Type irq_mask, uint8_t irq_priority);
